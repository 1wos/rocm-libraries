...
class TestPTS:
    ...
    def test_rocrand(self, benchmark, rockDir, dbIngress):
        ...
        for mtch in re.finditer(expr, out):
            ...
            # score multiplier
            scoreCard['bytes_per_second'] = utils.normBps(scoreCard.pop('bps'), scoreCard.pop('bpsMul'))
            scoreCard['items_per_second'] = utils.normIps(scoreCard.pop('ips'), scoreCard.pop('ipsMul'))
