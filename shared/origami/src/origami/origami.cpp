...
std::vector<prediction_result_t> rank_configs(const problem_t& problem,
  ...
  // ML path (TENSILE_ML_RECOMMENDER=1 or prediction_mode=ml_recommender).
  // Hybrid routing: if a per-cluster routing file marks the problem's cluster
  // as Origami-preferred, skip ML and fall through to the analytical path.
